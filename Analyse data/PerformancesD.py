...
means = [ Pf.mean(axis=0)[:30].mean(), Pf.mean(axis=0)[-30:].mean(), PfnG.mean(axis=0)[:30].mean(), PfnG.mean(axis=0)[-30:].mean()]
stds  = [ Pf.std(axis=0)[:30].std(),  Pf.std(axis=0)[-30:].std(), PfnG.std(axis=0)[:30].std(),  PfnG.std(axis=0)[-30:].std()]
...
means = [ PUf.mean(axis=0)[:30].mean(), PUf.mean(axis=0)[-30:].mean(),  PUfnG.mean(axis=0)[:30].mean(), PUfnG.mean(axis=0)[-30:].mean()]
stds  = [ PUf.std(axis=0)[:30].std(),  PUf.std(axis=0)[-30:].std(), PUfnG.std(axis=0)[:30].std(),  PUfnG.std(axis=0)[-30:].std()]
