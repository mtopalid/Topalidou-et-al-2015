...
def learning_trials(inversable = 0, reverse_all = True, reverse_trial = 50, less_trained_trials = 20, f = None, hist = False, trials = n_trials, debugging = True, save = False, protocol = 'Piron', familiar = True, type = 'learning', W_COG = None, W_MOT = None, W_STR = None, trained = False, j = -1, ncues = 2):
	...
	while not trained:
		...
		for j in range(less_trained_trials):
			...
			if hist:
				...
				RT, P = learning(f = f, trial_n = j, debugging = debugging, protocol = protocol, familiar = familiar, hist = hist, P = P, RT = RT, ncues = ncues)
