...
D2_std = D2.std()
plt.plot(X, D2_mean, c='b', lw=2)
plt.plot(X, D2_mean + D2_std, c='b', lw=.5)
plt.plot(X, D2_mean - D2_std, c='b', lw=.5)
plt.fill_between(X, D2_mean + D2_std, D2_mean - D2_std, color='b', alpha=.1)
#
...
D3_std = D3.std()
plt.plot(X, D3_mean, c='b', lw=2)
plt.plot(X, D3_mean + D3_std, c='b', lw=.5)
plt.plot(X, D3_mean - D3_std, c='b', lw=.5)
plt.fill_between(X, D3_mean + D3_std, D3_mean - D3_std, color='b', alpha=.1)
#
