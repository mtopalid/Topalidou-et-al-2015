...
tsk = "tasks/task-thomas-ass.json"
...
records = experiment.run(session, "Thomas Protocol No Str Ass-control")
...
fl = folderFig + "NoStrAss-control.pdf"
plt.savefig(fl)
...
fl = folderFig + "histogram-NoStrAss-control.pdf"
