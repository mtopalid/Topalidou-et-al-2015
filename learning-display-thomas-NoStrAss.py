...
rslt = folderRes + "NoStrAss.npy" #-NoCtx
rprt = folderRep + "NoStrAss.txt"#-NoCtx
experiment = Experiment(model = mdl,
						task = tsk,
						result = rslt,
						report = rprt,
						n_session = 25, n_block = 1, seed = 123)#None)
records = experiment.run(session, "Protocol No Str Cog")
...
fl = folderFig + "learning-NoStrAss.pdf"
plt.savefig(fl)
