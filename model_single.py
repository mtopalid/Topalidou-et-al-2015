...
class Model(object):
    ...
    def process(self, task, trial, stop=True, debug=False, cortical_activity=False):
        ...
        if decision is False and stop:
            ...
            LTP = _["Hebbian"]["LTP"]
            dw = LTP * self["CTX"]["ass"]["V"].reshape((4,4))[choice,choice]
            ...
            if cortical_activity:
                task.cortical_activity(self["CTX"]["cog"].history[:3000], self["CTX"]["mot"].history[:3000])
